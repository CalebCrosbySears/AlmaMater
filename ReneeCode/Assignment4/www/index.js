...
function getPositionSuccess(filePos) {
  ...
  $(document).ready(function(){
    var theLyric = Math.floor(filePos);
    var lyric;
  ...
  switch (theLyric)
   {
    ...
    lyric = "We have gained wisdom and honor";
      break;
    case 15:
    lyric = "From our home of green and grey";
      break;
    case 19:
    lyric = "We will go for that remembered";
      break;
    case 23:
    lyric = "Learned along the way";
      break;
    case 27:
    ...
    lyric = "And with dignity";
      break;
    case 44:
    lyric = "Georgia Gwinnett";
      break;
    case 48:
    lyric = "We'll never forget";
      break;
    case 52:
    lyric = "How we have grown";
      break;
    case 55:
    lyric = "And those that we met";
      break;
    case 60:
    lyric = "Georgia Gwinnett";
      break;
    case 64:
    lyric = "With love and respect";
      break;
    case 68:
    lyric = "Our Alma Mater";
      break;
    case 72:
    lyric = "Georgia Gwinnett";
      break;
...
/*
var lyrics = [
    {time: 10, lyric:"We have gained wisdom and honor"},
    {time: 15, lyric:"From our home of green and grey"},
    {time: 19, lyric:"We will go for that remembered"},
    {time: 23, lyric:"Learned along the way"},
    {time: 27, lyric:"And with knowledge and compassion"},
    {time: 31, lyric:"We will build communities"},
    {time: 36, lyric:"Leading by example"},
    {time: 40, lyric:"And with dignity"},
    {time: 44, lyric:"Georgia Gwinnett"},
    {time: 48, lyric:"We'll never forget"},
    {time: 52, lyric:"How we have grown"}
    {time: 55, lyric:"And those that we met"},
    {time: 60, lyric:"Georgia Gwinnett"},
    {time: 64, lyric:"With love and respect"},
    {time: 68, lyric:"Our Alma Mater"},
    {time: 72, lyric:"Georgia Gwinnett"},
    {time: 75, lyric:"Our Alma Mater"},
    {time: 82, lyric:"Georgia Gwinnett"}
];

var lyricDisplay;
for (i=0; i<lyrics.length; i++)
{
  lyricDisplay.innerText = lyrics[i].text + " ";
  if(function doPlay() = true)
  {
    document.getElementById('lyricDisplay')
  }
  else if (true) {
